...
In addition to the plot, CTBenchmarks.jl provides an automatic textual
analysis generated by `_analyze_profile_default_cpu(bench_id)` (used via
`INCLUDE_TEXT` blocks in the documentation). This analysis is computed from
