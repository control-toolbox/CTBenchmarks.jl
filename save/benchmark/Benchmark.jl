...
function Benchmark_OC(
    nb_discr_list=nb_discr_list,
    ...
    Results = benchmark_all_models_OC(
        functions_list,
        nb_discr_list,
        excluded_models;
        max_iter=max_iter,
...
function Benchmark_JuMP(
    ...
    Results = benchmark_all_models_JuMP(
        functions_list,
        nb_discr_list,
        excluded_models;
        max_iter=max_iter,
...
function Benchmark_model_TTonly(
    ...
    Results = benchmark_model_TTonly(
        model_key_list,
        nb_discr_list;
        max_iter=max_iter,
        tol=tol,
